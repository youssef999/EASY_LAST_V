...
import 'package:freelancerApp/features/payment/views/last_pay/map/next_last2.dart';
...
class LastWebView2 extends StatefulWidget {

Map<String,dynamic> data;
  String url;
  num price;

  LastWebView2({super.key,required this.url,required this.data,
    required this.price});

  @override
  State<LastWebView2> createState() => _LastWebViewState();
}

class _LastWebViewState extends State<LastWebView2> {
