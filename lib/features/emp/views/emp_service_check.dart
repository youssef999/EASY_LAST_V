...
import 'package:freelancerApp/features/emp/views/searchPlaces3.dart';
import 'package:freelancerApp/features/emp/views/select_location2.dart';
import 'package:get/get.dart';
import 'package:get_storage/get_storage.dart';
import 'package:google_fonts/google_fonts.dart';

class EmpCheckoutView2 extends StatefulWidget {
  Map<String, dynamic> data;
  DocumentSnapshot data2;

  EmpCheckoutView2({super.key, required this.data,
    required this.data2
  });

  @override
  State<EmpCheckoutView2> createState() => _CheckOutViewState();
}

class _CheckOutViewState extends State<EmpCheckoutView2> {
        ...
        child: ListView(children: [
          ...
          Padding(
            ...
            child: CustomButton(
                ...
                onPressed: () {
                  print("data====="+widget.data.toString());
                  controller.addEmpOrderToFireStore2(widget.data2);
                }),
          ),
